                        ...
                        : level === "4" ? "text-gray-500"
                            : level === "3" ? "text-gray-400"
                                : level === "2" ? "text-gray-200"
                                    : level === "1" ? "text-gray-50"
                                        : "hidden"} key={skill.id}>#{skill.name} </div>
        );
    })
    ...
    return (
        <div className="mx-auto max-w-7xl">
            <div className="container max-w-lg px-4 py-12 mx-auto text-center md:max-w-none md:text-center">
                ...
                <h1 className="text-3xl flex justify-center flex-nowrap font-extrabold leading-10 tracking-tight text-gray-900 md:text-center sm:leading-none sm:text-xl md:text-6xl lg:text-7xl">
